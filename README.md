# poker44-miner-gen10heur12

Minimal release repository for model gen10heur12.

## Quick start

```bash
git clone https://github.com/tomkaba/poker44-miner-gen10heur12.git
cd poker44-miner-gen10heur12
python3 -m venv .venv
...
- Scorer is hardcoded to `gen10heur12`.
