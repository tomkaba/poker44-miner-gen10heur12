...
MANIFEST_REPO_URL="${POKER44_MODEL_REPO_URL:-https://github.com/tomkaba/poker44-miner-gen10heur12}"
...
for raw_id in $(echo "$IDS_STRING" | tr ',' '\n'); do
  ...
  screen -dmS "$SESSION" /bin/bash -c "
    ...
    export POKER44_SINGLE_HAND_MODEL_ALIAS=gen10heur12
    export POKER44_CHUNK_SCORER=gen10heur12
    ...
    echo '[runtime] CHUNK_SCORER=gen10heur12'
